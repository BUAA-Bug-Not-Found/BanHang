...
export default {
  ...
  setup() {
    ...
    const question = ref({
      ...
      userId: 1,
      userName: "test_user",
      quesContent: "<h1>Lorem ipsum dolor sit amet consectetur adipisicing elit.</h1> " +
    ...
    const answers = ref([
      {
        ...
        ansContent: "<h1>Lorem ipsum dolor sit amet consectetur adipisicing elit.</h1> \" +\n" +
            "          \"Commodi, ratione debitis quis est labore voluptatibus! Eaque cupiditate minima, \" +\n" +
            "          \"at placeat totam, magni doloremque veniam neque porro libero rerum unde voluptatem!\"",
        ansState: '1',
